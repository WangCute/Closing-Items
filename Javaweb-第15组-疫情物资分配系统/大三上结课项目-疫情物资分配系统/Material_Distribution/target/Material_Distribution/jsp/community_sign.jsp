...
<div class="warehouse_issue">
    ...
    <div class="main">
        ...
        <table>
            ...
            <c:forEach items="${requestScope.listApply}" var="item" varStatus="status">
                <tr>
                    <td>${item.order}</td>
                    ...
                    <td>${item.urgency}</td>
                    <td>${item.state}</td>
                    <td><a href="/OrderSigningServlet?id=${item.id}" onclick="dianji()">确认签收</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
